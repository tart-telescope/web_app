...
function createPolygonCoordinates(coordinates) {
  ...
  polygonGeometry.setAttribute("position", new BufferAttribute(new Float32Array(vertices), 3));
  polygonGeometry.setAttribute("color", new BufferAttribute(new Float32Array(colors), 3));
