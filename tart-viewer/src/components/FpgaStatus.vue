            ...
            <v-card variant="outlined">
              ...
              <v-card-text>
                <div
                  ...
                  :class="{
                    'flash-change': isFieldChanged('AQ_SYSTEM.enabled'),
                  }"
                >
                  <span>Enabled:</span>
                ...
                <div
                  class="d-flex justify-space-between mb-2"
                  :class="{
                    'flash-change': isFieldChanged('AQ_SYSTEM.SDRAM_ready'),
                  }"
                >
                ...
                <div
                  class="d-flex justify-space-between mb-2"
                  :class="{
                    'flash-change': isFieldChanged('AQ_SYSTEM.overflow'),
                  }"
                >
                  <span>Overflow:</span>
            ...
            <v-card variant="outlined">
              ...
              <v-card-text>
                <div
                  class="d-flex justify-space-between mb-2"
                  :class="{
                    'flash-change': isFieldChanged('SYS_STATS.acq_en'),
                  }"
                >
                ...
                <div
                  class="d-flex justify-space-between mb-2"
                  :class="{
                    'flash-change': isFieldChanged('SYS_STATS.cap_en'),
                  }"
                >
                ...
                <div
                  class="d-flex justify-space-between mb-2"
                  :class="{
                    'flash-change': isFieldChanged('SYS_STATS.viz_en'),
                  }"
                >
                ...
                <div
                  class="d-flex justify-space-between mb-2"
                  :class="{
                    'flash-change': isFieldChanged('SYS_STATS.cap_debug'),
                  }"
                >
                ...
                <div
                  class="d-flex justify-space-between mb-2"
                  :class="{
                    'flash-change': isFieldChanged('SYS_STATS.viz_pend'),
                  }"
                >
            ...
            <v-card variant="outlined">
              ...
              <v-card-text>
                <div
                  class="d-flex justify-space-between mb-2"
                  :class="{
                    'flash-change': isFieldChanged('TC_SYSTEM.enabled'),
                  }"
                >
                  <span>Enabled:</span>
                ...
                <div
                  class="d-flex justify-space-between mb-2"
                  :class="{
                    'flash-change': isFieldChanged('TC_SYSTEM.locked'),
                  }"
                >
                  <span>Locked:</span>
                ...
                <div
                  class="d-flex justify-space-between mb-2"
                  :class="{
                    'flash-change': isFieldChanged('TC_SYSTEM.source'),
                  }"
                >
                  <span>Source:</span>
                  <v-chip color="info" size="small">
            ...
            <v-card variant="outlined">
              ...
              <v-card-text>
                <div
                  class="d-flex justify-space-between mb-2"
                  :class="{
                    'flash-change': isFieldChanged('SPI_STATS.spi_busy'),
                  }"
                >
                  <span>SPI Busy:</span>
                ...
                <div
                  class="d-flex justify-space-between mb-2"
                  :class="{
                    'flash-change': isFieldChanged('SPI_STATS.FIFO_overflow'),
                  }"
                >
                ...
                <div
                  class="d-flex justify-space-between mb-2"
                  :class="{
                    'flash-change': isFieldChanged('SPI_STATS.FIFO_underrun'),
                  }"
                >
            ...
            <v-card variant="outlined">
              ...
              <v-card-text>
                <div
                  class="d-flex justify-space-between mb-2"
                  :class="{
                    'flash-change': isFieldChanged('TC_CENTRE.centre'),
                  }"
                >
                  <span>Centre:</span>
                ...
                <div
                  class="d-flex justify-space-between mb-2"
                  :class="{
                    'flash-change': isFieldChanged('TC_CENTRE.invert'),
                  }"
                >
                  <span>Invert:</span>
            ...
            <v-card variant="outlined">
              ...
              <v-card-text>
                ...
                <div
                  class="d-flex justify-space-between mb-2"
                  :class="{
                    'flash-change': isFieldChanged('TC_DEBUG.numantenna'),
                  }"
                >
            ...
            <v-card variant="outlined">
              ...
              <v-card-text>
                <div
                  class="d-flex justify-space-between mb-2"
                  :class="{
                    'flash-change': isFieldChanged('VX_SYSTEM.enabled'),
                  }"
                >
                  <span>Enabled:</span>
                ...
                <div
                  class="d-flex justify-space-between mb-2"
                  :class="{
                    'flash-change': isFieldChanged('VX_SYSTEM.overwrite'),
                  }"
                >
                  <span>Overwrite:</span>
                ...
                <div
                  class="d-flex justify-space-between mb-2"
                  :class="{
                    'flash-change': isFieldChanged('VX_SYSTEM.blocksize'),
                  }"
                >
            ...
            <v-card variant="outlined">
              ...
              <v-card-text>
                ...
                <div
                  class="d-flex justify-space-between mb-2"
                  :class="{
                    'flash-change': isFieldChanged('VX_STATUS.available'),
                  }"
                >
                  <span>Available:</span>
                  <v-chip color="info" size="small">
                ...
                <div
                  class="d-flex justify-space-between mb-2"
                  :class="{
                    'flash-change': isFieldChanged('VX_STATUS.accessed'),
                  }"
                >
                  <span>Accessed:</span>
                  <v-chip color="info" size="small">
                ...
                <div
                  class="d-flex justify-space-between mb-2"
                  :class="{
                    'flash-change': isFieldChanged('VX_STATUS.overflow'),
                  }"
                >
                  <span>Overflow:</span>
